...
class OpenAIModel(HuggingFaceModel):
    ...
    def __init__(
        self, model_id="text-davinci-002", openai_api_key=None
        ) -> None: #, openai_org=None
        import os
        ...
        self.tokenizer = AutoTokenizer.from_pretrained("colorfulscoop/gpt2-small-ja")
        self.tokenizer.pad_token = self.tokenizer.eos_token
    ...
    def surprise(
        ...
        for b in range(len(batched)):
            ...
            accum_dict = {'tokens':tokens[3:], 'surprisals':-logprobs[3:]}
            accumulator.append(accum_dict)
        #     accumulator += [
        #         HuggingFaceSurprisal(
